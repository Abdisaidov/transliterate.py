...
def to_cyrillic(text):
    ...
    text = re.sub(
    r'\b(%s)' % '|'.join(words_start_with_g_o.keys()),
    lambda x: words_start_with_g_o[x.group(1)],
    text,
    flags=re.U
    )
